...
class PlacesSearch
  ...
  def single_place_search_details(results)
    ...
    place_photo = spot.photos[0].fetch_url(400)
  ...
  def place_search_details(results)
    ...
    # puts
    # puts
    # puts Paint["Screw it! It's too complicated, just get takeway!", :yellow, :bold]
    # puts
    # puts Paint["We found these restaurants nearby", :yellow]
